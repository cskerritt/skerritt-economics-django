...
CITY_DATA = {
    'alabama': {
        ...
        'state_abbr': 'AL',
        'cities': [
            {'name': 'Birmingham', 'slug': 'birmingham', 'population': '209403', 'county': 'Jefferson County', 'lat': 33.5186, 'lng': -86.8104},
            {'name': 'Montgomery', 'slug': 'montgomery', 'population': '198525', 'county': 'Montgomery County', 'lat': 32.3668, 'lng': -86.3000},
            {'name': 'Huntsville', 'slug': 'huntsville', 'population': '215006', 'county': 'Madison County', 'lat': 34.7304, 'lng': -86.5861},
            {'name': 'Mobile', 'slug': 'mobile', 'population': '187041', 'county': 'Mobile County', 'lat': 30.6954, 'lng': -88.0399},
            {'name': 'Tuscaloosa', 'slug': 'tuscaloosa', 'population': '101129', 'county': 'Tuscaloosa County', 'lat': 33.2098, 'lng': -87.5692},
            {'name': 'Hoover', 'slug': 'hoover', 'population': '92606', 'county': 'Jefferson County', 'lat': 33.4054, 'lng': -86.8114},
            {'name': 'Dothan', 'slug': 'dothan', 'population': '71072', 'county': 'Houston County', 'lat': 31.2232, 'lng': -85.3905},
            {'name': 'Auburn', 'slug': 'auburn', 'population': '76143', 'county': 'Lee County', 'lat': 32.6099, 'lng': -85.4808},
            {'name': 'Decatur', 'slug': 'decatur', 'population': '57938', 'county': 'Morgan County', 'lat': 34.6059, 'lng': -86.9833},
            {'name': 'Madison', 'slug': 'madison', 'population': '56933', 'county': 'Madison County', 'lat': 34.6993, 'lng': -86.7483},
            {'name': 'Florence', 'slug': 'florence', 'population': '40184', 'county': 'Lauderdale County', 'lat': 34.7998, 'lng': -87.6773},
            {'name': 'Gadsden', 'slug': 'gadsden', 'population': '33945', 'county': 'Etowah County', 'lat': 34.0143, 'lng': -86.0066},
            {'name': 'Prattville', 'slug': 'prattville', 'population': '37781', 'county': 'Autauga County', 'lat': 32.4640, 'lng': -86.4597},
            {'name': 'Vestavia Hills', 'slug': 'vestavia-hills', 'population': '39102', 'county': 'Jefferson County', 'lat': 33.4488, 'lng': -86.7877},
            {'name': 'Phenix City', 'slug': 'phenix-city', 'population': '38816', 'county': 'Russell County', 'lat': 32.4710, 'lng': -85.0008},
            {'name': 'Alabaster', 'slug': 'alabaster', 'population': '33284', 'county': 'Shelby County', 'lat': 33.2443, 'lng': -86.8164},
            {'name': 'Opelika', 'slug': 'opelika', 'population': '30995', 'county': 'Lee County', 'lat': 32.6454, 'lng': -85.3783},
            {'name': 'Enterprise', 'slug': 'enterprise', 'population': '28220', 'county': 'Coffee County', 'lat': 31.3152, 'lng': -85.8552},
            {'name': 'Northport', 'slug': 'northport', 'population': '26272', 'county': 'Tuscaloosa County', 'lat': 33.2290, 'lng': -87.5772},
            {'name': 'Anniston', 'slug': 'anniston', 'population': '21287', 'county': 'Calhoun County', 'lat': 33.6598, 'lng': -85.8316},
            {'name': 'Prichard', 'slug': 'prichard', 'population': '19322', 'county': 'Mobile County', 'lat': 30.7388, 'lng': -88.0789},
            {'name': 'Athens', 'slug': 'athens', 'population': '25406', 'county': 'Limestone County', 'lat': 34.8026, 'lng': -86.9728},
            {'name': 'Daphne', 'slug': 'daphne', 'population': '27462', 'county': 'Baldwin County', 'lat': 30.6035, 'lng': -87.9036},
            {'name': 'Pelham', 'slug': 'pelham', 'population': '24318', 'county': 'Shelby County', 'lat': 33.2857, 'lng': -86.8100},
            {'name': 'Oxford', 'slug': 'oxford', 'population': '22069', 'county': 'Calhoun County', 'lat': 33.6143, 'lng': -85.8350},
            {'name': 'Albertville', 'slug': 'albertville', 'population': '22256', 'county': 'Marshall County', 'lat': 34.2676, 'lng': -86.2088},
            {'name': 'Homewood', 'slug': 'homewood', 'population': '26414', 'county': 'Jefferson County', 'lat': 33.4718, 'lng': -86.8008},
            {'name': 'Bessemer', 'slug': 'bessemer', 'population': '26019', 'county': 'Jefferson County', 'lat': 33.4018, 'lng': -86.9544},
            {'name': 'Fairhope', 'slug': 'fairhope', 'population': '22477', 'county': 'Baldwin County', 'lat': 30.5229, 'lng': -87.9033},
            {'name': 'Talladega', 'slug': 'talladega', 'population': '15268', 'county': 'Talladega County', 'lat': 33.4359, 'lng': -86.1058},
        ]
    },
    'rhode-island': {
